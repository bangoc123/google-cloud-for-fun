...
<img src="./guide-images/clone-the-project-to-cloud-shell.png">
...
- You **own** this repository, meaning that if you are only the collborator, you can not link the travis to your project.
